...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ onLogout }) => {
  ...
  // If Stories tab is selected, render the StoriesManagementPage
  if (activeTab === 'stories') {
    return <StoriesManagementPage onBack={() => setActiveTab('overview')} />;
  }

  // If Banners tab is selected, render the BannersManagementPage
  if (activeTab === 'banners') {
    return <BannersManagementPage onBack={() => setActiveTab('overview')} />;
  }
